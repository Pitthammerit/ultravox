...
export const TRANSCRIPTION_VARIANTS: VariantMeta[] = [
  ...
  { id: "base.en",        label: "Lite",     size: "~142 MB", description: "More accurate",                  tooltip: "Base.en is trained on English-only data — more accurate than Tiny for English dictation at a modest size increase (~142 MB).", isEnglish: true },
  { id: "base",           label: "Lite",     size: "~142 MB", description: "Balanced",                       tooltip: "Base is the multilingual sibling of Base.en (~142 MB). Handles non-English languages with good accuracy and reasonable speed." },
